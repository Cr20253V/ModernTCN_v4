...
- 模型文件: `E:\Matlab\Simulink\S-Function_16\results\paper\agv_model_parameter_correction_workflow\08_models\models\TCN_model_full_tcn_v5_plantfix_passive17_plus_all5_seed101.mat`
- 最佳轮次: 74
- 主任务基座最佳轮次: 32
- 最佳验证损失: 1.106456
- 最佳选择分数: 4.872158
...
| 转弯过渡窗口准确率 | 0.4247 |
| 坡度 MAE deg | 0.8631 |
| |theta|<=10 P95 deg | 2.1418 |
| [-10,-8] P95 deg | 1.9998 |
| [8,10] P95 deg | 4.0798 |
| [-2,-0.5] P95 deg | 2.2417 |
| [0.5,2] P95 deg | 2.2670 |
| near-flat abs P95 deg | 2.1810 |
| flat theta bias deg | 0.3045 |
...
|---|---:|---:|---:|---:|
| flat | 345 | 3 | 408 | 0.4563 |
| stall | 24 | 51 | 21 | 0.5312 |
| slope | 329 | 137 | 2284 | 0.8305 |
...
|---|---:|---:|---:|---:|
| right | 289 | 389 | 121 | 0.3617 |
| straight | 316 | 1300 | 317 | 0.6725 |
| left | 159 | 344 | 367 | 0.4218 |
...
|---|---:|---:|---:|---:|---:|---:|
| uphill | 1744 | 0.6284 | 0.8591 | 0.9748 | [0.056, 9.750] | [-2.112, 14.095] |
| downhill | 1762 | 0.9058 | 0.8670 | 0.9308 | [-9.750, -0.235] | [-10.320, 2.159] |
