...
- 生成时间: 2026-04-28 19:21:51
- 训练模式: `physics_guided`
- 数据集: `E:\Matlab\Simulink\S-Function_16\data\tcn\TCN_dataset_v2_transition_rich.mat`
- 模型文件: `E:\Matlab\Simulink\S-Function_16\data\models\TCN_model_transition_rich_v2_seed101_staged.mat`
- 最佳轮次: 71
- 主任务基座最佳轮次: 44
- 最佳验证损失: 0.411647
- 最佳选择分数: 1.307928
...
|---|---:|---:|---:|---:|
| flat | 546 | 13 | 14 | 0.9529 |
| stall | 0 | 78 | 0 | 1.0000 |
| slope | 10 | 59 | 248 | 0.7823 |
...
| straight | 16 | 657 | 28 | 0.9372 |
| left | 5 | 42 | 105 | 0.6908 |
...
|---|---:|---:|---:|---:|---:|---:|
| uphill | 223 | 0.7265 | 0.3521 | 1.0000 | [2.014, 6.000] | [1.700, 8.333] |
| downhill | 94 | 0.9149 | 1.2379 | 0.9894 | [-5.500, -2.074] | [-5.404, 1.637] |
