...
- 生成时间: 2026-04-28 17:05:49
- 训练模式: `physics_guided`
- 数据集: `E:\Matlab\Simulink\S-Function_16\data\tcn\TCN_dataset_v2_transition_rich.mat`
- 模型文件: `E:\Matlab\Simulink\S-Function_16\data\models\TCN_model_transition_rich_v2_seed11_staged.mat`
- 最佳轮次: 78
- 主任务基座最佳轮次: 34
- 最佳验证损失: 0.797536
- 最佳选择分数: 3.142912
...
|---|---:|---:|---:|---:|
| flat | 535 | 12 | 26 | 0.9337 |
| stall | 0 | 78 | 0 | 1.0000 |
| slope | 25 | 77 | 215 | 0.6782 |
...
| straight | 17 | 652 | 32 | 0.9301 |
| left | 5 | 25 | 122 | 0.8026 |
...
|---|---:|---:|---:|---:|---:|---:|
| uphill | 223 | 0.5785 | 0.3853 | 1.0000 | [2.014, 6.000] | [1.664, 8.747] |
| downhill | 94 | 0.9149 | 0.5285 | 0.9894 | [-5.500, -2.074] | [-5.909, 1.843] |
