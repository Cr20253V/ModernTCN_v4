...
- 生成时间: 2026-04-28 18:17:35
- 训练模式: `physics_guided`
- 数据集: `E:\Matlab\Simulink\S-Function_16\data\tcn\TCN_dataset_v2_transition_rich.mat`
- 模型文件: `E:\Matlab\Simulink\S-Function_16\data\models\TCN_model_transition_rich_v2_seed42_staged.mat`
- 最佳轮次: 75
- 主任务基座最佳轮次: 58
- 最佳验证损失: 0.427006
- 最佳选择分数: 0.085554
...
|---|---:|---:|---:|---:|
| flat | 551 | 7 | 15 | 0.9616 |
| stall | 0 | 78 | 0 | 1.0000 |
| slope | 12 | 26 | 279 | 0.8801 |
...
| straight | 16 | 654 | 31 | 0.9330 |
| left | 5 | 45 | 102 | 0.6711 |
...
|---|---:|---:|---:|---:|---:|---:|
| uphill | 223 | 0.8520 | 0.4791 | 1.0000 | [2.014, 6.000] | [1.612, 8.808] |
| downhill | 94 | 0.9468 | 0.5024 | 0.9894 | [-5.500, -2.074] | [-5.732, 0.914] |
