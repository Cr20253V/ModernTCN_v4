...
- 生成时间: 2026-04-26 11:19:38
- 训练模式: `physics_guided`
- 数据集: `E:\Matlab\Simulink\S-Function_16\data\tcn\TCN_dataset_processed.mat`
- 模型文件: `E:\Matlab\Simulink\S-Function_16\data\models\TCN_model_smoke_pipeline_grid_tmp_main_neg2p0_down0p15_turn0p10_global_linear_readout.mat`
- 最佳轮次: 1
- 最佳验证损失: 1.032548
- 最佳选择分数: 1.456928
- 主任务基座选择分数: 1.456928
