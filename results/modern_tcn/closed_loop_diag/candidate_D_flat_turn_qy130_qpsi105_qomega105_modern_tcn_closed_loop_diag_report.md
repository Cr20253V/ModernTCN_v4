...
- out file: `E:\Matlab\Simulink\S-Function_16\results\modern_tcn\control_turn_tests\candidate_D_flat_turn_qy130_qpsi105_qomega105.mat`
...
|---|---:|---:|---:|---|
| pure_turn_false_slope_pct | 0.000 | <= 5 | yes | Flat turn should not be classified as slope. |
| pure_turn_left_recall_pct | 93.786 | >= 80 | yes | Flat left turn should be detected before labels are used by MPC. |
| pure_turn_theta_mae_deg | 2.588 | <= 2 | no | Theta estimate should stay near zero on flat turns. |
| pure_slope_main_acc_pct | 93.900 | >= 90 | yes | Pure slope segment should be recognized consistently. |
| pure_slope_theta_mae_deg | 1.004 | <= 2 | yes | Slope magnitude error should remain below controller-use tolerance. |
...
| closure_accel_per_current_ood_pct | 21.906 | <= 5 | no | Large accel/current ratio OOD points to low-load sample coverage gap. |
...
| pure_turn | 0.0277 | 0.0677 | 0.0192 | 2.588 | 100.0 | 96.8 | 100.0/0.0/0.0 | 0.0/6.2/93.8 |
| pure_slope | 0.0057 | 0.0190 | 0.1100 | 1.004 | 93.9 | 92.3 | 41.2/0.0/58.8 | 6.2/88.5/5.2 |
| composite | 0.0097 | 0.0217 | 0.0747 | 0.606 | 94.2 | 46.0 | 53.1/0.0/46.9 | 10.2/88.8/1.1 |
| closed_loop | 0.0058 | 0.0549 | 0.0112 | 1.561 | 100.0 | 91.5 | 100.0/0.0/0.0 | 3.1/25.2/71.7 |
| closure | 0.0058 | 0.0549 | 0.0112 | 1.561 | 100.0 | 91.5 | 100.0/0.0/0.0 | 3.1/25.2/71.7 |
...
| feature | median z | p95 abs z | max abs z | pct abs z > 3 |
|---|---:|---:|---:|---:|
| delta_lf | 1.661 | 1.704 | 1.704 | 0.0 |
| kappa_proxy | 1.605 | 1.644 | 1.644 | 0.0 |
| delta_rr | -1.541 | 1.575 | 1.575 | 0.0 |
| accel_per_current | 0.049 | 1.568 | 8.933 | 2.8 |
| gyro_z | 1.164 | 1.400 | 2.478 | 0.0 |
| I_sum | -1.164 | 1.396 | 1.498 | 0.0 |
| omega_wheel_lf | -1.184 | 1.244 | 1.250 | 0.0 |
| ws_imbalance | 0.602 | 1.103 | 2.421 | 0.0 |
...
| omega_wheel_rr | -0.315 | 1.395 | 1.434 | 0.0 |
| I_sum | -0.149 | 1.356 | 1.538 | 0.0 |
...
| accel_per_current | 0.054 | 2.220 | 3.779 | 0.6 |
| omega_wheel_rr | -0.325 | 1.420 | 1.456 | 0.0 |
| v_hat | -0.342 | 1.404 | 1.443 | 0.0 |
| I_sum | -0.892 | 1.388 | 1.505 | 0.0 |
...
| feature | median z | p95 abs z | max abs z | pct abs z > 3 |
|---|---:|---:|---:|---:|
| accel_per_current | -0.002 | 10.134 | 12.294 | 21.9 |
| v_hat | -1.189 | 3.382 | 3.850 | 8.1 |
| omega_wheel_rr | -1.066 | 3.341 | 3.805 | 7.8 |
| omega_wheel_lf | -1.278 | 3.329 | 3.794 | 7.7 |
| I_sum | -1.348 | 1.495 | 1.505 | 0.0 |
| ws_imbalance | -0.171 | 1.083 | 1.103 | 0.0 |
| accel_x_lp | -0.058 | 0.974 | 1.003 | 0.0 |
| delta_rr | -0.928 | 0.931 | 1.408 | 0.0 |
...
| feature | median z | p95 abs z | max abs z |
|---|---:|---:|---:|
| delta_lf | 1.661 | 1.704 | 1.704 |
| kappa_proxy | 1.605 | 1.644 | 1.644 |
| delta_rr | -1.541 | 1.575 | 1.575 |
| accel_per_current | 0.049 | 1.568 | 8.933 |
| gyro_z | 1.164 | 1.400 | 2.478 |
| I_sum | -1.164 | 1.396 | 1.498 |
| omega_wheel_lf | -1.184 | 1.244 | 1.250 |
| ws_imbalance | 0.602 | 1.103 | 2.421 |
...
| omega_wheel_rr | -0.315 | 1.395 | 1.434 |
| I_sum | -0.149 | 1.356 | 1.538 |
...
| accel_per_current | 0.054 | 2.220 | 3.779 |
| omega_wheel_rr | -0.325 | 1.420 | 1.456 |
| v_hat | -0.342 | 1.404 | 1.443 |
| I_sum | -0.892 | 1.388 | 1.505 |
