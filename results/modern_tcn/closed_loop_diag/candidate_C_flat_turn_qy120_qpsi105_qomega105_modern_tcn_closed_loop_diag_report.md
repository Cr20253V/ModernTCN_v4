...
- out file: `E:\Matlab\Simulink\S-Function_16\results\modern_tcn\control_turn_tests\candidate_C_flat_turn_qy120_qpsi105_qomega105.mat`
...
|---|---:|---:|---:|---|
| pure_turn_false_slope_pct | 0.750 | <= 5 | yes | Flat turn should not be classified as slope. |
| pure_turn_left_recall_pct | 93.786 | >= 80 | yes | Flat left turn should be detected before labels are used by MPC. |
| pure_turn_theta_mae_deg | 2.549 | <= 2 | no | Theta estimate should stay near zero on flat turns. |
| pure_slope_main_acc_pct | 93.900 | >= 90 | yes | Pure slope segment should be recognized consistently. |
| pure_slope_theta_mae_deg | 1.003 | <= 2 | yes | Slope magnitude error should remain below controller-use tolerance. |
...
| closure_accel_per_current_ood_pct | 21.688 | <= 5 | no | Large accel/current ratio OOD points to low-load sample coverage gap. |
...
| pure_turn | 0.0281 | 0.0680 | 0.0192 | 2.549 | 99.2 | 96.8 | 99.2/0.0/0.8 | 0.0/6.2/93.8 |
| pure_slope | 0.0057 | 0.0191 | 0.1100 | 1.003 | 93.9 | 92.9 | 41.2/0.0/58.8 | 5.7/89.0/5.2 |
| composite | 0.0098 | 0.0217 | 0.0747 | 0.594 | 94.2 | 45.6 | 53.1/0.0/46.9 | 10.2/88.7/1.1 |
| closed_loop | 0.0059 | 0.0551 | 0.0112 | 1.644 | 100.0 | 90.7 | 100.0/0.0/0.0 | 3.1/25.9/71.0 |
| closure | 0.0059 | 0.0551 | 0.0112 | 1.644 | 100.0 | 90.7 | 100.0/0.0/0.0 | 3.1/25.9/71.0 |
...
| feature | median z | p95 abs z | max abs z | pct abs z > 3 |
|---|---:|---:|---:|---:|
| delta_lf | 1.662 | 1.704 | 1.704 | 0.0 |
| kappa_proxy | 1.605 | 1.644 | 1.644 | 0.0 |
| delta_rr | -1.541 | 1.575 | 1.575 | 0.0 |
| accel_per_current | 0.050 | 1.563 | 8.931 | 2.7 |
| gyro_z | 1.166 | 1.404 | 2.477 | 0.0 |
| I_sum | -1.161 | 1.396 | 1.498 | 0.0 |
| omega_wheel_lf | -1.185 | 1.243 | 1.259 | 0.0 |
| ws_imbalance | 0.604 | 1.103 | 2.420 | 0.0 |
...
| accel_per_current | 0.054 | 2.220 | 3.786 | 0.6 |
...
| feature | median z | p95 abs z | max abs z | pct abs z > 3 |
|---|---:|---:|---:|---:|
| accel_per_current | -0.002 | 10.134 | 12.298 | 21.7 |
| v_hat | -1.189 | 3.382 | 3.850 | 8.1 |
| omega_wheel_rr | -1.066 | 3.341 | 3.805 | 7.8 |
| omega_wheel_lf | -1.278 | 3.328 | 3.793 | 7.7 |
| I_sum | -1.347 | 1.495 | 1.505 | 0.0 |
| ws_imbalance | -0.170 | 1.079 | 1.103 | 0.0 |
| accel_x_lp | -0.058 | 0.974 | 1.003 | 0.0 |
| delta_rr | -0.928 | 0.931 | 1.399 | 0.0 |
...
| feature | median z | p95 abs z | max abs z |
|---|---:|---:|---:|
| delta_lf | 1.662 | 1.704 | 1.704 |
| kappa_proxy | 1.605 | 1.644 | 1.644 |
| delta_rr | -1.541 | 1.575 | 1.575 |
| accel_per_current | 0.050 | 1.563 | 8.931 |
| gyro_z | 1.166 | 1.404 | 2.477 |
| I_sum | -1.161 | 1.396 | 1.498 |
| omega_wheel_lf | -1.185 | 1.243 | 1.259 |
| ws_imbalance | 0.604 | 1.103 | 2.420 |
...
| accel_per_current | 0.054 | 2.220 | 3.786 |
