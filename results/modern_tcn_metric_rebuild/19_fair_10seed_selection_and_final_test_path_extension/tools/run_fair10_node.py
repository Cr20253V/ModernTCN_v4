...
NODE_ROOT = ROOT / "results" / "modern_tcn_metric_rebuild" / "19_fair_10seed_selection_and_final_test_path_extension"
...
def _patch_base_module() -> None:
    ...
    _base.FINAL_TEST_PATHS = [
        ...
        ROOT / "data" / "paths" / "modern_tcn_showcase" / "candidates" / "path_modern_tcn_showcase_candidate_factory_flat_logistics_safe_190_v1.mat",
        ROOT / "data" / "paths" / "factory_targeted_eval" / "path_factory_target_downhill_straight_after_turn_v1.mat",
    ]
