# ModernTCN run config

- model_family: `small`
- loss_mode: `bounded_uncertainty`
- run_tag: `a3_full_small_lr_seed101`
- output_dir: `E:\Matlab\Simulink\S-Function_16\results\modern_tcn_metric_rebuild\15_bi_bu_uncertainty_stabilization\03_baseline_initialized\a3_full_small_lr_seed101`
- git_hash: `e6bef51a3ed5e4bf6d0f59f24852439dd5a05823`
...
```json
{
  ...
  "s_range": 0.5,
  "s_prior_lambda": 0.03,
  "raw_s_main": -0.06463416665792465,
  "s_main": -0.032272156327962875,
  "weight_main": 1.0327985286712646,
  "raw_s_turn": -0.06493864953517914,
  "s_turn": -0.03242376074194908,
  "weight_turn": 1.0329550504684448,
  "raw_s_theta": -0.06499113142490387,
  "s_theta": -0.03244988992810249,
  "weight_theta": 1.0329821109771729,
  "freeze_mode": "none",
  "freeze_early_blocks": 3,
  "preserve_mode": "baseline",
  "lambda_preserve_main": 0.1,
