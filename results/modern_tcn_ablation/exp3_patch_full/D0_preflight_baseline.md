# D0 Baseline And Legacy Exclusion Preflight
...
- excluded_legacy_full_artifacts: `results/modern_tcn_ablation/exp3_patch_full/excluded_legacy_full_artifacts.json`
- excluded_legacy_count: `140`
- rule: `D8 summary may read only exp3_patch_full/full128_*_seed* summaries from this run.`
- warm_start_policy: `forbidden; every full128 run starts from random initialization.`
