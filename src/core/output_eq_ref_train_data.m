...
% =============================
% 文件名：output_eq_ref_train_data.m
% 版本号：V4.6-Train
% 派生自：output_eq_ref.m (V4.x)
% 最后修改时间：2025-11-02
% 作者：LPV-MPC Project
% 
% 【重要】本文件专用于GRU训练数据生成！
...
% 
% 同步策略：
%   - 如修改核心物理参数、测量模型，需同步更新原版output_eq_ref.m
...
mu_base = params.friction_coefficient;
...
% [9-11] IMU测量（添加噪声）
% V4.6-Train: 纵向加速度计算中增加stall_load影响
...
% 运动状态指标
lateral_accel = v * omega; % 横向加速度估计 [m/s^2]
